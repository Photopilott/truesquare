...
import {
  countPublicOwnerContributions,
  getPublicOwnerAggregates,
} from '@/lib/owner-aggregates';
import { getRegisteredTransactions } from '@/lib/registered-transactions';

export const dynamic = 'force-dynamic';

export const metadata: Metadata = {
  title: 'Bengaluru market explorer — FlatData',
  description:
    'Explore registered apartment transaction evidence across FlatData’s four supported Bengaluru markets.',
};
