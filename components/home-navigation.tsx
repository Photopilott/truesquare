...
export function HomeNavigation() {
  ...
  return (
    <main id="home" className="ts-orb min-h-screen overflow-hidden">
      <div className="ts-orb-announcement"><strong>INDEPENDENT</strong><span>No listings sold. No leads sold. No data sold.</span></div>
      <header className="ts-orb-shell ts-orb-nav">
        <div className="contents">
          <a href="#home" className="ts-orb-brand" aria-label="TrueSquare home">
            TrueSquare
          </a>
          ...
          <nav className="ts-orb-nav-links" aria-label="Main navigation">
            ...
            <a href="#paths" className="ts-orb-button ts-orb-button-dark ts-orb-button-small">
              GET STARTED
            </a>
          </nav>

          <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
            <SheetTrigger render={<Button variant="outline" size="icon-lg" className="lg:hidden" aria-label="Open navigation" />}>
      ...
      <section className="ts-orb-shell ts-orb-hero">
        <div>
          ...
          <p className="ts-orb-note">Look around freely. You&apos;ll only need to sign in when you want your numbers.</p>
        </div>
        ...
        <div className="ts-orb-trust-card">
          ...
          <div className="ts-orb-trust-top">
            ...
            <div>
              ...
              <h2 className="mt-2 font-heading text-[35px] font-medium leading-none">A clearer starting point</h2>
            </div>
            </div>
          </div>
          <div className="ts-orb-trust-body">
            {[
              ...
              <div key={title} className="flex items-center gap-4 border-b border-border pb-4 last:border-0 last:pb-0">
          ...
          <div className="ts-orb-evidence-strip">
            <div><strong>Range</strong><span>Not certainty</span></div>
            <div><strong>Count</strong><span>Evidence shown</span></div>
            <div><strong>Private</strong><span>Units hidden</span></div>
          </div>
        </div>
      </section>
      ...
      <section id="paths" className="ts-orb-section scroll-mt-24">
        <div className="ts-orb-shell">
          <div className="ts-orb-section-head">
            <div><p className="ts-orb-eyebrow">CHOOSE YOUR PATH</p><h2 className="ts-orb-section-title">Where would you like to start?</h2></div>
            <p className="ts-orb-section-copy">Look around freely. You&apos;ll only need to sign in when you want your numbers.</p>
          </div>
          ...
          <div className="mx-auto mt-6 flex max-w-4xl justify-center">
            <Link href={selectedHref} className="ts-orb-button ts-orb-button-dark w-full max-w-md">
      ...
      <section id="coverage" className="ts-orb-section ts-orb-mint scroll-mt-24">
        <div className="ts-orb-shell">
          <div className="ts-orb-section-head">
            <div><p className="ts-orb-eyebrow">LAUNCH COVERAGE</p><h2 className="ts-orb-section-title">Focused before broad</h2></div>
            <p className="ts-orb-section-copy">The first release stays within the four Bengaluru markets supported by the current property database.</p>
          </div>
      ...
      <footer className="ts-orb-footer">
        <div className="ts-orb-shell flex justify-between gap-5">
          <a href="#home" className="ts-orb-brand">TrueSquare</a>
